...
public:
	...
	void DrawLED(GraphicsInfo r_GfxInfo, bool selected = false, bool is_high=false) const;
	void DrawSWITCH(GraphicsInfo r_GfxInfo, bool selected = false, bool is_on = false) const;
